...
def parse_opts():
	...
	parser.add_argument(
		'--test_images',
		default='/home/neuroplex/Downloads/VeRi/image_test',
		type=str,
		help='Root directory path of data')
	parser.add_argument(
		'--train_annotation_path',
		default='/home/neuroplex/Downloads/VeRi/train_label.xml',
		type=str,
		help='Annotation file path')
	parser.add_argument(
		'--test_annotation_path',
		default='/home/neuroplex/Downloads/VeRi/test_label.xml',
		type=str,
		help='Annotation file path')
	parser.add_argument(
		'--gpu',
